...
public class ETL_LoadGraphsInNeo4j {
    ...
    public static void main(String[] args) throws IOException {
        ...
        obj.insertInGraphDB(path1, path2);
    }
     ...
     * @throws IOException
     */
    void insertInGraphDB(String path1, String newDBpath) throws IOException {
        long time1 = System.currentTimeMillis();


        //human igraph
        String path = newDBpath+ "/humanIgraph";
        File file2 = new File(path1 + "/iGraph/human.igraph");
        ...
        //human queries
         file2 = new File(path1+ "/iGraph/human_q10.igraph");
        ...
        // yeast igraph
        file2 = new File(path1 + "/iGraph/yeast.igraph");
    ...
    // yeast queries
        file2 = new File(path1 + "/iGraph/yeast_q10.igraph");
        ...
        File file = new File(path1 + "/Proteins/Proteins/target/");
        //loading the protein graphs
        loadProteinGraph(file, newDBpath);
        // loading the protein queries
        file = new File(path1 + "/Proteins/Proteins/query/");
        loadProteinGraph(file, newDBpath);
